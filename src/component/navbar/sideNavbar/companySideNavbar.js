...
const CompanySidebar = () => {
  return (
    <ul className="mt-6 space-y-2">
      <li>
        <Link to="/create/job" className="flex items-center px-4 py-2 hover:bg-gray-700 rounded">
      ...
      <li>
        <Link to="/post/job" className="flex items-center px-4 py-2 hover:bg-gray-700 rounded">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
