                        ...
                        {paginatedJobs.map(job => (
                            ...
                            >
                                ...
                                <div className="flex mt-2 md:mt-0 items-center space-x-2">
                                    <button
                                        className={`mt-2 w-24 py-1.5 ${job.applied ? 'border-2 border-customBlue text-customBlue font-bold rounded-md' : 'border-2 border-customBlue text-customBlue font-bold rounded-md'}`}
